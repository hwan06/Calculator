...
public class calculatorController implements Initializable {
	...
	@FXML Button btn0,btn1,btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9,btnAdd,btnMinus,btnDiv,btnMul,btnClear,btnEq;
	@FXML Label lblR, lblD;
	
	
	CalculatorModel sc = new CalculatorModel();
	int n,x,y,result;
	String op;
	String num = "";
	...
	public void btnMinusActon(ActionEvent event) {
		op = "-";
		makelog(op);
	}
	
	public void btnMulActon(ActionEvent event) {
		op = "X";
		makelog(op);
	}
